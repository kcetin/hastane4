...
class RehberCopyWidget extends StatefulWidget {
  RehberCopyWidget({Key key}) : super(key: key);

  @override
  _RehberCopyWidgetState createState() => _RehberCopyWidgetState();
}

class _RehberCopyWidgetState extends State<RehberCopyWidget> {
